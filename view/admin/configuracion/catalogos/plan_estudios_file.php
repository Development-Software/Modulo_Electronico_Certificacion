<form id="form-plan-file" style="text-align: center;" enctype="multipart/form-data">
    <div>
    ...
    <div class="row">
        <div class="col-md-5">
            ...
            <div class="row justify-content-center">
                <div class="form-group">
                    <input type="file" name="file_plan" id="file_plan" class="input-file" accept=".xlsx,.xls,.csv">
                    <label for="file_plan" class="btn btn-tertiary js-labelFile">
                        <i class="icon fa fa-check"></i>
                        <span class="js-fileName">Archivo Plan Estudios</span>
                    </label>
                </div>
            </div>
            <br>
            <div class="row justify-content-center">
                <div id="valida" class="col-md-4"><input id="carga_plan" type="button" class="btn btn-secondary" value="Cargar Datos"></input></div>
        ...
        <div class="col-md-5" style="margin: auto;">
            <div class="row justify-content-center">
                ...
                <a id="descarga_plan" target="_blank"><input type="image" src="../../img/catalogos/Excel.png" width="60px" style="margin-top: 15px;"></a>
            </div>
        </div>
    </div>
</form>
...
<script>
    $('#descarga_plan').click(function(e) {
        e.preventDefault(); //stop the browser from following
        window.location.href = '../../files/layouts/Planes_Estudio.xlsx';
    });
...
<script>
    $("#carga_plan").on("click", function(e) {
        //debugger;


        if ($("#file_plan")[0].files.length == 0) {
            Swal.fire({
        ...
        var f = $(this);
        var formData = new FormData(document.getElementById("form-plan-file"));
        formData.append("dato", "valor");
        $.ajax({
                url: "../../controller/catalogos/controller_carga_plan.php",
                type: "post",
                dataType: "JSON",
                data: formData,
                cache: false,
