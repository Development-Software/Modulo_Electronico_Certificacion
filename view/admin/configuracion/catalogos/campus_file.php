<form id="form-campus-file" style="text-align: center;" enctype="multipart/form-data">
    <div>
    ...
    <div class="row">
        <div class="col-md-5">
            ...
            <div class="row justify-content-center">
                <div class="form-group">
                    <input type="file" name="file_campus" id="file_campus" class="input-file" accept=".xlsx,.xls,.csv">
                    <label for="file_campus" class="btn btn-tertiary js-labelFile">
                        <i class="icon fa fa-check"></i>
                        <span class="js-fileName">Archivo de Campus</span>
                    </label>
                </div>
            </div>
            <br>
            <div class="row justify-content-center">
                <div id="valida" class="col-md-4"><input id="carga_campus" type="button" class="btn btn-secondary" value="Cargar Datos"></input></div>
        ...
        <div class="col-md-5" style="margin: auto;">
            <div class="row justify-content-center">
                ...
                <a id="descarga_campus" target="_blank"><input type="image" src="../../img/catalogos/Excel.png" width="60px" style="margin-top: 15px;"></a>
            </div>
        </div>
    </div>
</form>
<script>
    $('#descarga_campus').click(function(e) {
        e.preventDefault(); //stop the browser from following
        window.location.href = '../../files/layouts/Campus.xlsx';
    });
...
<script>
    $("#carga_campus").on("click", function(e) {
        debugger;

        
        if ($("#file_campus")[0].files.length == 0) {
            Swal.fire({
            ...
            var file = $('#file_campus')[0].files[0];
        ...
        var f = $(this);
        var formData = new FormData(document.getElementById("form-campus-file"));
        formData.append("dato", "valor");

        $.ajax({
                url: "../../controller/catalogos/controller_carga_campus.php",
                type: "post",
                dataType: "JSON",
                data: formData,
                cache: false,
