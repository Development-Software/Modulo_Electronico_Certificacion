<form id="form-materias-file" style="text-align: center;" enctype="multipart/form-data">
    <div>
    ...
    <div class="row">
        <div class="col-md-5">
            ...
            <div class="row justify-content-center">
                <div class="form-group">
                    <input type="file" name="file_materias" id="file_materias" class="input-file" accept=".xlsx,.xls,.csv">
                    <label for="file_materias" class="btn btn-tertiary js-labelFile">
                        <i class="icon fa fa-check"></i>
                        <span class="js-fileName">Archivo Materias</span>
                    </label>
                </div>
            </div>
            <br>
            <div class="row justify-content-center">
                <div id="valida" class="col-md-4"><input id="carga_materias" type="button" class="btn btn-secondary" value="Cargar Datos"></input></div>
        ...
        <div class="col-md-5" style="margin: auto;">
            <div class="row justify-content-center">
                ...
                <a id="descarga_materias" target="_blank"><input type="image" src="../../img/catalogos/Excel.png" width="60px" style="margin-top: 15px;"></a>
            </div>
        </div>
    </div>
</form>
...
<script>
    $('#descarga_materias').click(function(e) {
        e.preventDefault(); //stop the browser from following
        window.location.href = '../../files/layouts/Materias.xlsx';
    });
...
<script>
    $("#carga_materias").on("click", function(e) {
        //debugger;


        if ($("#file_materias")[0].files.length == 0) {
            Swal.fire({
            ...
            var file = $('#file_materias')[0].files[0];
        ...
        var f = $(this);
        var formData = new FormData(document.getElementById("form-materias-file"));
        formData.append("dato", "valor");
        $.ajax({
                url: "../../controller/catalogos/controller_carga_materias.php",
                type: "post",
                dataType: "JSON",
                data: formData,
                cache: false,
