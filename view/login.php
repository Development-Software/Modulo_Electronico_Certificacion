...
<head>
  ...
  <link rel="stylesheet" href="css/mectheme.css">
  ...
  <script src="css/themes/fas/theme.js"></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-fileinput/5.1.3/js/locales/es.min.js"></script>
...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo"><b>UniverMilenium</b><br />MEC 2.0</div>
        <!-- /.login-logo -->
        <div class="card">
